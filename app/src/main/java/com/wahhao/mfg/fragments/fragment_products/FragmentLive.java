...
public class FragmentLive extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public void loadData(){
        try {
            ...
            txtTitle1.setText(language_data.getString("noLive"));
                            ...
                            public void success(SavedProductList basic_response, Response response) {
                                ...
                                try{
                                    if(basic_response.getResponse().getProducts().size()>0){
                                        ...
                                        adapSaved=new AdaptorSavedProduct(getContext(),dataProduct,language_data,3);
