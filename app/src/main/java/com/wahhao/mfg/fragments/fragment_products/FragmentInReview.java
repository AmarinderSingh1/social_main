...
public class FragmentInReview extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void loadData(){
        try {
            ...
            txtTitle1.setText(language_data.getString("noInReview"));
                                ...
                                public void success(SavedProductList basic_response, Response response) {
                                    ...
                                    try {
                                        if (basic_response.getResponse().getProducts().size() > 0) {
                                            ...
                                            adapSaved = new AdaptorSavedProduct(getContext(), dataProduct, language_data, 2);
