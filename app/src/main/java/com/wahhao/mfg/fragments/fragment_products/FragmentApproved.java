...
public class FragmentApproved extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{

    private View view;
    public static JSONObject language_data;
    public static RelativeLayout relNoData;
    public static TextView txtTitle1,txtTitle2,txtTitle3,txtTitle4;
    public static Button btnAddProd1, btnAddprod2,btnSendSample;
    public static RecyclerView listSavedData;
    ...
    public void loadData(){
        try {
            ...
            txtTitle1.setText(language_data.getString("noApproved"));
                            ...
                            public void success(SavedProductList basic_response, Response response) {
                                ...
                                try{
                                    if(basic_response.getResponse().getProducts().size()>0){
                                        ...
                                        adapSaved=new AdaptorSavedProduct(getContext(),dataProduct,language_data,5);
